...
|   ![](Image3.jpg)
|
|   A partir de là, il est possible de naviguer dans votre machine grâce à la fonction `cd`. Par exemple, je peux me rendre dans mon projet *Reproducibility*:
|   ![](Image4.jpg)
|
|   Une fois positionné dans votre projet vous pouvez en afficher le contenu grâce à la fonction `ls -l` :
|   ![](Image5.jpg)
|
|   Vous n'en n'aurez pas l'utilité ici mais quelques autres fonctions bash utiles sont :
+   `touch ` :